package com.app.meatz.data.utils.swipeReveal
...
class SwipeRevealLayout : ViewGroup {
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        for (index in 0 until childCount) {
            ...
            Log.i("childWidth", measuredChildWidth.toString())
            when (dragEdge) {
                DRAG_EDGE_RIGHT -> {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        Log.i("desiredWidth", "onMeasure:$measuredWidth ")
    ...
    private val mainOpenLeft: Int
        get() = when (dragEdge) {
            DRAG_EDGE_LEFT -> mRectMainClose.left + (mSecondaryView!!.width - 20)
            DRAG_EDGE_RIGHT -> mRectMainClose.left - (mSecondaryView!!.width - 20)
