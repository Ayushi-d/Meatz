...
class KhashtaAdapter(spinnerDataList: ArrayList<CarnivalKhashtaSize>, context: Context) : BaseAdapter() {
    private val mContext: Context = context
    private val mSpinnerDataList: ArrayList<CarnivalKhashtaSize> = spinnerDataList
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        title?.text = mSpinnerDataList[position].size
